...
public class AddChildActivity extends AppCompatActivity {
    ...
    String strName, strEmail, strUser, strGender, strPass, strEducation, strAge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtEmail.getEditText().setText(LoginActivity.parent.getParentEmail());
    ...
    class AddChild extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                parameters.add(new BasicNameValuePair("parentID", strID));
                JSONObject parser = jsonParser.makeHttpRequest(Links.url_add_child_link, "POST", parameters);
