...
import com.example.codingforkids.adapters.ProgressChildAdapter;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ProgressChildAdapter adapter = new ProgressChildAdapter(ViewProgressActivity.this, childsData);
