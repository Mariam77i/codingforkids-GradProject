...
public class ParentEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strName = LoginActivity.parent.getParentName();
        strEmail = LoginActivity.parent.getParentEmail();
        strPass = LoginActivity.parent.getParentPass();
    ...
    class EditProfileProcess extends AsyncTask<String, String, String> {
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject parser = jsonParser.makeHttpRequest(Links.url_edit_parent_link, "POST", parameters);
