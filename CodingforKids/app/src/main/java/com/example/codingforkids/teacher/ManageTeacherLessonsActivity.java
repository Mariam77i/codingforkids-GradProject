...
public class ManageTeacherLessonsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_teacher_lessons);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if(lesson.getString("strID").equals(strID)){
                            ...
                            ManageLessonAdapter adapter = new ManageLessonAdapter(ManageTeacherLessonsActivity.this, lessonsData);
