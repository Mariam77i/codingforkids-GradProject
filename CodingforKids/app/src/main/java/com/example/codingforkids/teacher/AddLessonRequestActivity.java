...
public class AddLessonRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_lesson_request);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View v) {
                       Intent in = new Intent(getApplicationContext(), ParentActivity.class);
                       startActivity(in);
                   }
               }
        );
        btnSave.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   if (spinLang.getSelectedItem().toString().equals("Choose Programming Language") ||
                       ...
                       new AddLessonRequest().execute();
                   }
               }
           }
        );
    }
    class AddLessonRequest extends AsyncTask<String, String, String> {
        @Override
        ...
        public String doInBackground(String... args) {
            ...
            try {
                ...
                JSONObject parser = jsonParser.makeHttpRequest(Links.url_add_lesson_request_link, "POST", parameters);
                success = parser.getInt("success");
                if (success == 1) {
                    String lessonID = parser.getString("message");
                    Intent intent = new Intent(getApplicationContext(), ViewTutorialsActivity.class);
                    intent.putExtra("come", "1");
                    startActivity(intent);
                    return  parser.getString("New Lesson added") ;
                }
                else {
